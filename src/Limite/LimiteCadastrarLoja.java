...
public class LimiteCadastrarLoja extends JPanel {
    ...
    public LimiteCadastrarLoja(){
        
        setLayout(new GridBagLayout());
        setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.blue), "Cadastrar Loja"));
